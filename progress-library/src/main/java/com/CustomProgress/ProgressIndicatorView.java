...
import com.CustomProgress.indicators.BallPulseIndicator;
...
public class ProgressIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.ProgressIndicatorView, defStyleAttr, defStyleRes);

        mMinWidth = a.getDimensionPixelSize(R.styleable.ProgressIndicatorView_minWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.ProgressIndicatorView_maxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.ProgressIndicatorView_minHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.ProgressIndicatorView_maxHeight, mMaxHeight);
        String indicatorName=a.getString(R.styleable.ProgressIndicatorView_indicatorName);
        mIndicatorColor=a.getColor(R.styleable.ProgressIndicatorView_indicatorColor, Color.WHITE);
