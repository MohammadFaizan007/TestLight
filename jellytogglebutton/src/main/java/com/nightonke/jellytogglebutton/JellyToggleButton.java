...
public class JellyToggleButton extends CompoundButton {
    ...
    private static final int DEFAULT_LEFT_TEXT_SIZE = 18;
    private static final int DEFAULT_RIGHT_TEXT_SIZE = 18;
...
//        Log.w("mBackgroundRadius",mBackgroundRadius+"");
//        Log.w("mBackgroundRadius12",backgroundLeft+""+backgroundRight);
        mBackgroundRectF.set(
                backgroundLeft,
                getMeasuredHeight() / 4 - mBackgroundRadius,
                backgroundRight,
                getMeasuredHeight() /2 + (mBackgroundRadius+10));
    ...
    private void drawRoundedRect(Canvas canvas, float left, float top, float right, float bottom,Paint mainPaint) {
        float radius = getHeight() / 2;
//        Log.w("Canvas",left+" "+top+" "+right+" "+bottom+" "+radius);
        canvas.drawCircle(radius, radius, radius, mainPaint);
        canvas.drawCircle(right - radius, radius, radius, mainPaint);
        canvas.drawRect(left + radius, 0, right - radius, getHeight(), mainPaint);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //canvas.drawRoundRect(mBackgroundRectF, 30, 30, mPaint);
        drawRoundedRect(canvas,mBackgroundRectF.left,mBackgroundRectF.top,mBackgroundRectF.right,mBackgroundRectF.bottom,mPaint);
        // thumb
